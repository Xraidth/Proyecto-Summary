...
#1) Ingreso de URL de YOUTUBE
#2) texto = TextExtractor(URL) <-Obtiene el texto
#FALTA 3) resumen = Sintetizator(texto) <-Obtiene el resumen  
#4) textTime = TextWithTime(URL) <-Obtiene los tiempos del texto dentro del video
